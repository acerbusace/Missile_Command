...
public class World{
	...
	private int numOfMissilesLvl1; //how much ammo the player gets on Level 1
	private int numOfMissilesLvl2; //how much ammo the player gets on Level 2
	private int numOfMissilesLvl3; //how much ammo the player gets on Level 3
	private int numOfMissilesLvl4; //how much ammo the player gets on Level 4
	private int numOfMissilesLvl5; //how much ammo the player gets on Level 5
	...
	private int lvl1Kills; //how many kills the player requires on Level 1
	private int lvl2Kills; //how many kills the player requires on Level 2
	private int lvl3Kills; //how many kills the player requires on Level 3
	private int lvl4Kills; //how many kills the player requires on Level 4
	private int lvl5Kills; //how many kills the player requires on Level 5
